...
public class MainActivity extends Activity
{
    ...
    private String mBaseUrl = "http://192.168.129.1:8888/FileUpload/FileUploadServlet";
...
//        params.put("password", "123");
        ...
        String url = "http://192.168.129.1:8888/FileUpload/FileUploadServlet";
    ...
    {
        File file = new File(Environment.getExternalStorageDirectory()+"/download/", "1.png");
        File file2 = new File(Environment.getExternalStorageDirectory()+"/download/", "temp.jpg");
        Toast.makeText(MainActivity.this, file.getAbsolutePath()+"   "+file2.getAbsolutePath(), Toast.LENGTH_SHORT).show();
...
//        params.put("password", "123");
    ...
    {
        String url = "http://192.168.129.1:8888/tomcat.png";
        OkHttpUtils//
                .get()//
                .url(url)//
                .build()//
                .execute(new FileCallBack(Environment.getExternalStorageDirectory().getAbsolutePath(), "tomcat.png")//
                {
