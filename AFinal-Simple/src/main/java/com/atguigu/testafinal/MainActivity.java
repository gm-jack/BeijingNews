...
public class MainActivity extends Activity {
    ...
    String path= Environment.getExternalStorageDirectory()+"/download/2.avi";
    public void downloadFile(View view){
        FinalHttp fh = new FinalHttp();
        fh.download("http://192.168.129.1:8888/upload_file_service/2.avi", path, new AjaxCallBack<File>() {
            @Override
