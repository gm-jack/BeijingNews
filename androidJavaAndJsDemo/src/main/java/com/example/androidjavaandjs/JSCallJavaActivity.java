...
//		webView.loadUrl("file:///android_asset/JsCallJava.html");
		webView.loadUrl("http://192.168.129.1:8888/JsCallJava.html");
	...
	private final class Contact {
		...
		public void call(String phone) {
			...
			if (ActivityCompat.checkSelfPermission(JSCallJavaActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
		...
		public void showcontacts() {
			...
			handler.post(new Runnable() {
				...
				public void run() {
					...
					//视频信息
					String jsonVideo = "[{\"name\":\"我是视频点击播放\", \"amount\":\"9999\", \"phone\":\"http://192.168.129.1:8888/2.avi\"}]";
